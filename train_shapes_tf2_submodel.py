...
from mrcnn_tf2 import smodel as modellib
...
mrcnn_class, mrcnn_bbox, target_class_ids, \
target_bbox, target_mask, mrcnn_mask=out

DL = mutil.DetectionLayer(config, name="mrcnn_detection")
rois = model.target_rois
input_image_meta = inputs[1]
...
tmodel = modellib.MaskRCNN(mode="inference", 
