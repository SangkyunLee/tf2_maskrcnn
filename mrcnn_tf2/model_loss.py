# -*- coding: utf-8 -*-
"""
Created on Thu Dec 26 23:29:15 2019
...
def rpn_bbox_loss_graph(config, target_bbox, rpn_match, rpn_bbox):
    ...
    batch_counts = tf.math.reduce_sum(KB.cast(KB.equal(rpn_match, 1), tf.int32), axis=1)
...
def mrcnn_bbox_loss_graph(target_bbox, target_class_ids, pred_bbox):
    ...
    pred_bbox = tf.reshape(pred_bbox, (-1, KB.int_shape(pred_bbox)[2], 4))
